"""
YOLO Pose Model Inference Script with Video Output

This script runs a specified YOLO pose model on a reference video and saves
the output video with pose predictions visualized.

USAGE:
    python run_pose_on_video.py
...
# Available models in root: yolo26n-pose.pt, yolo26s-pose.pt, yolo26m-pose.pt, yolo26l-pose.pt, yolo26x-pose.pt
