...
def segment_image(
    image_path: str = "test2.jpg",
    model_path: str = "yolo11s-seg.pt",
    output_path: str = "yolo11s-seg.jpg",
    conf: float = 0.25
) -> None:
    """
    ...
    Args:
        ...
        model_path: YOLO segmentation model, e.g. yolo11s-seg.pt
...
if __name__ == "__main__":
    segment_image(
        ...
        model_path="yolo11s-seg.pt",    # or yolo11s-seg.pt
